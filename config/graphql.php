...
return [
    ...
    'schemas' => [
        ...
        'user' => [
            ...
            'mutation' => [
                'user' => App\GraphQL\Mutations\UserMutation::class,
                'company' => App\GraphQL\Mutations\CompanyMutation::class,
                'article' => App\GraphQL\Mutations\ArticleMutation::class,
            ],
    ...
    'types' => [
        ...
        'company_input' => App\GraphQL\Inputs\CompanyInput::class,
        'article_input' => App\GraphQL\Inputs\ArticleInput::class,

        'response_type' => App\GraphQL\Types\ResponseType::class,
        'user_type' => App\GraphQL\Types\UserType::class,
        'company_type' => App\GraphQL\Types\CompanyType::class,
        'article_type' => App\GraphQL\Types\ArticleType::class,
